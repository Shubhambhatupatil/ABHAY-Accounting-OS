...
begin
  ...
  perform create_default_ledger(target_company_id, expense_group_id, 'Mobile Recharge Expense', 'indirect_expense', 'expense');
  perform create_default_ledger(target_company_id, expense_group_id, 'Communication Expense', 'indirect_expense', 'expense');
  perform create_default_ledger(target_company_id, expense_group_id, 'Internet & Phone Expense', 'indirect_expense', 'expense');
